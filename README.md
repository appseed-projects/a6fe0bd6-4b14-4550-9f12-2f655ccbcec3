...
- Timestamp: `2022-05-21 20:22`
- Build ID: `a6fe0bd6-4b14-4550-9f12-2f655ccbcec3`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/a6fe0bd6-4b14-4550-9f12-2f655ccbcec3.git
$ cd a6fe0bd6-4b14-4550-9f12-2f655ccbcec3
```
